...
public class PersonsService : IPersonsService
{
    ...
    {
        List<Person> result = await _personsRepository.GetAllPersons();
    ...
    public async Task<PersonResponse> UpdatePersonAsync(PersonUpdateRequest? personUpdateRequest)
    {
        ...
        Person? matchingPerson = await _personsRepository.GetPersonByPersonID(personUpdateRequest.PersonID) ?? throw new ArgumentException("Given person id doesn't exist");
