...
namespace Services
{
    public class PersonsService : IPersonsService
    {
        ...
        {
            return _dbContext.Persons.ToList().Select(ConvertPersonToPersonResponse).ToList();
        }
        ...
        public PersonResponse UpdatePerson(PersonUpdateRequest? personUpdateRequest)
        {
            ...
            Person? matchingPerson = _dbContext.Persons.FirstOrDefault(temp => temp.PersonID == personUpdateRequest.PersonID) ?? throw new ArgumentException("Given person id doesn't exist");
