...
public class CountriesServiceTest
{
    ...
    public async Task AddCountry_DuplicateCountryName_ToBeArgumentException()
    {
        ...
        CountryResponse first_country_from_add_country = await _countriesService.AddCountryAsync(first_country_request);
        ...
        var action = async () =>
        {
            ...
            await _countriesService.AddCountryAsync(second_country_request);
        };
    ...
    public async Task AddCountry_FullCountry_ToBeSuccessful()
    {
        ...
        //Act
        CountryResponse country_from_add_country = await _countriesService.AddCountryAsync(country_request);
    ...
    public async Task GetAllCountries_ToBeEmptyList()
    {
        ...
        //Act
        List<CountryResponse> actual_country_response_list = await _countriesService.GetAllCountriesAsync();
    ...
    public async Task GetAllCountries_ShouldHaveFewCountries()
    {
        ...
        //Act
        List<CountryResponse> actualCountryResponseList = await _countriesService.GetAllCountriesAsync();
    ...
    public async Task GetCountryByCountryID_NullCountryID_ToBeNull()
    {
        ...
        //Act
        CountryResponse? country_response_from_get_method = await _countriesService.GetCountryByCountryIDAsync(countryID);
    ...
    public async Task GetCountryByCountryID_ValidCountryID_ToBeSuccessful()
    {
        ...
        //Act
        CountryResponse country_response_from_get = await _countriesService.GetCountryByCountryIDAsync(country.CountryID);
